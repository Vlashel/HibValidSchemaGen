 ...
 * @since 26.09.2014
 */
@SchemaTitle("home address title")
@SchemaDescription("home address description")
@SchemaVersion("http://json-schema.org/draft-03/schema#")
public class HomeAddressDto extends Address {
    @Size(max = 30)
    @NotNull
    @SchemaTitle("this is the home city title")
